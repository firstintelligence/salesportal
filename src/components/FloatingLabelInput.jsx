  ...
  return (
    <div className="relative">
      <input
        ...
        id={id}
        name={name}
        className={`block px-2.5 pb-2.5 pt-4 w-full min-h-[40px] md:h-[40px] h-[48px] text-sm text-gray-900 bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer ${disabled ? 'cursor-not-allowed' : ''} ${className}`}
        placeholder=" "
        value={value}
