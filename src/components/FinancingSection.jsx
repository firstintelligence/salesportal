...
const FinancingSection = ({ financing, setFinancing, invoiceAmount = 0, showContractorFees = false, setShowContractorFees = () => {} }) => {
  ...
  return (
    <div className="mb-6 bg-green-50 p-4 rounded-lg h-full flex flex-col">
      <h2 className="text-lg font-semibold mb-2 whitespace-nowrap">Financing Payment Details</h2>
