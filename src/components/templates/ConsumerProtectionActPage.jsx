...
const ConsumerProtectionActPage = ({ companyInfo }) => {
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "11px", lineHeight: "1.6", marginBottom: "14px" }}>
      ...
      <div style={{ marginLeft: "32px", marginBottom: "14px" }}>
        <p style={{ fontSize: "11px", lineHeight: "1.6", marginBottom: "4px" }}>
          a) The supplier.
        </p>
      ...
      <div style={{ marginLeft: "32px", marginBottom: "20px" }}>
        <p style={{ fontSize: "11px", lineHeight: "1.8", marginBottom: "4px" }}>
