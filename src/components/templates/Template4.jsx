      ...
      <div className="bg-white h-full flex flex-col">
        ...
        <div className="mt-auto pt-2" style={{pageBreakInside: 'avoid'}}>
            <div className="flex gap-8 mb-2">
              <div style={{flex: '0 0 auto', minWidth: '280px', maxWidth: '400px'}}>
                <h3 className="text-xs font-semibold mb-8" style={{color: '#194578'}}>Customer Signature</h3>
                {signature ? (
              ...
              {data.billTo?.coApplicantName && (
                <div style={{flex: '0 0 auto', minWidth: '280px', maxWidth: '400px'}}>
                  <h3 className="text-xs font-semibold mb-8" style={{color: '#194578'}}>Co-Applicant Signature</h3>
        ...
        <div style={{pageBreakBefore: 'always'}}>
            ...
            <div className="flex gap-8 mt-8">
              <div style={{flex: '0 0 auto', minWidth: '280px', maxWidth: '400px'}}>
                <h3 className="text-sm font-semibold mb-10" style={{color: '#194578'}}>Customer Signature</h3>
                {signature ? (
              ...
              {data.billTo?.coApplicantName && (
                <div style={{flex: '0 0 auto', minWidth: '280px', maxWidth: '400px'}}>
                  <h3 className="text-sm font-semibold mb-10" style={{color: '#194578'}}>Co-Applicant Signature</h3>
                  {coApplicantSignature ? (
                    <div className="mb-2 flex items-center border-b-2 border-gray-400 h-[120px]">
                      <img src={coApplicantSignature} alt="Co-Applicant Signature" style={SIGNATURE_STYLE} />
                    </div>
