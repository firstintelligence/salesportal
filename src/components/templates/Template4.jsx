        ...
        {isFirstPage && (
          <>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              ...
              <div className="bg-gray-100 p-3 rounded" style={{backgroundColor: '#f8f9fa'}}>
                ...
                <p className="text-xs">{yourCompany.address ? (() => {
                  ...
                  // If no comma exists after street number and name, add one before city
                  if (!/^\d+\s+[^,]+,/.test(address)) {
                    return address.replace(/^(\d+\s+[^,\s]+(?:\s+[^,\s]+)*)\s+([A-Z][a-z]+)/, '$1, $2');
                  }
                  return address;
            ...
            <div className="flex-1 mt-2">
              ...
              {/* Terms and Conditions and Additional Notes - only on first page */}
